...
from prepareCSV import roundDatas
from checkScore import getScore
...
def create_model(opt_='adamax'):
    ...
    model = Sequential()
    model.add(Conv2D(32, (3, 3), input_shape=input_shape_aux, padding='same', activation='relu', kernel_constraint=maxnorm(3)))
...
if __name__ == "__main__":
    ...
    roundDatas('submission.csv', name_file_csv)
    getScore(name_file_csv + '.csv' , SOLUTION_SGT1)

...
list_baldwiniana_1 = [50588398,50999460,50759018,51012340]
list_baldwiniana_2 = [52105990,51131610,52441302,50507962]
list_lamarckiana_1 = [51284308,49943602,51605300,49809190]

#plt.plot(list_algorithm_standar)  # Dibuja el gráfico de la lista list_algorithm_standar
plt.xlabel("Apariciones")   # Inserta el título del eje X
plt.ylabel("Fitness")   # Inserta el título del eje Y
plt.plot(list_algorithm_standar, marker='x', linestyle=':', color='b', label = "Algoritmo estándar")
plt.plot(list_baldwiniana_1, marker='*', linestyle='-', color='y', label = "Baldwiniana.Vecino mas cercano")
plt.plot(list_baldwiniana_2, marker='o', linestyle='--', color='r', label = "Baldwiniana.2-opt")
plt.plot(list_lamarckiana_1, marker='^', linestyle='-.', color='c', label = "Lamarckiana.Vecino mas cercano")

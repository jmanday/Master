...
#   which with the size of 5×5 and a rectifier activation function.This is the input layer,
#   expecting images with the structure outline above [pixels][width][height].
# 2. Next we define a pooling layer that takes the max called MaxPooling2D. It is configured with
#   a pool size of 2×2.

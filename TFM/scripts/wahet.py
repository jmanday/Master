...
PATH_OUTPUTS = "/Users/jesusgarciamanday/Documents/Master/TFM/outputs/segmentation/wahet/"
...
if __name__ == "__main__":
    ...
    for img in images_CASIAV4:
        cmd = ("./wahet -i " + PATH_DATABASES_2 + img + " -o " + PATH_OUTPUTS + img.split('.')[0] + "-texture.png" + " -s 512 64 -e")
